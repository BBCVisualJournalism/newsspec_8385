(function () {
    ...
    IframeWatcher.prototype = {
        ...
        createIframe: function (linkId) {
            ...
            this.elm.src = href + '&hostid=' + hostId.split('//')[1] + '&iframeUID=' + linkId + '&onbbcdomain=' + onBBC + urlParams;
        ...
        addLoadingSpinner: function (link, linkId) {
            ...
            spinnerHolder.id                    = linkId + '--bbc-news-visual-journalism-loading-spinner';
